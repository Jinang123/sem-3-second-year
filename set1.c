...
int find_sematric_difference_unioun(int array1[], int array2[], int * sematric_difference_array, int difference_1_size, int difference_2_size);


int main(){
    int array1[SIZE], array2[SIZE], unioun_array[2*SIZE], intersection_array[SIZE], difference_array_1[SIZE], difference_array_2[SIZE], sematric_difference_array[SIZE], n, i, j;
    ...
    n = find_sematric_difference_unioun(difference_array_1, difference_array_2, sematric_difference_array, i, j);
    printf("Sematric Difference Array :");
    display(sematric_difference_array, n);
...
int find_sematric_difference_unioun(int array1[], int array2[], int * sematric_difference_array, int difference_1_size, int difference_2_size){
    ...
    {
        sematric_difference_array[k] = array1[i];
        k++;
    }
    ...
    for (int i = 0; i < difference_1_size; i++)
    {
        ...
        {
            sematric_difference_array[k] = array2[i];
            k++;
        }
    }
    return k;
